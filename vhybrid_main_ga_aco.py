...
logFile = './logs/hybrid_result.txt'
imageFile = './images/hybrid_result.png'
...
if __name__ == '__main__':
    ...
    startTime = time.time()
    distance, bestDistances, nGeneration, timeExecution = hybridGaAco(city, nAnts, rho, alpha, beta, InitialPheromne, startTime, timeCriteria, log, DEBUG=DEBUG)
