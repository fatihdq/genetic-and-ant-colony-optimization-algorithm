...
def geneticAlgorithm(population, popSize, startTime, timeCriteria, log, DEBUG=False):
    tabulistResult = []
    finalPopulation = []
    pop = []
    ...
    return finalPopulation, bestDistance, progress, nGeneration, timeExecution